...
while True:
    ...
    if not is_jumping:
        screen.blit(
            player_walk_frames[player_walk_index // 5],
            (player_x, GROUND_Y - player_stand.get_height()),
        )
    ...
    screen.blit(
        snail_frames[snail_index // 5],
        (snail_x - snail_width, GROUND_Y - snail_frames[0].get_height()),
    )
